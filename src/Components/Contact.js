  ...
  return(
    <div className='contact' id='contact'>
      ...
      <div className='socialMedia'>
        <a href='https://github.com/jamesdorr3' target="_blank" rel="noopener noreferrer"><img alt="logo for GitHub" src='GitHub-Mark-Light-120px-plus.png' className='logo'/></a>
